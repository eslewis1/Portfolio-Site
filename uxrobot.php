...
<div class="page-wrapper">
    <div class="main-introT">
        ...
        <div class="main-img-group">
            <img src="images/uxrobot/materials.jpg" id="robot-img-materials">
        </div>

        <div class="main-text">
            <p> I had the participants examine 3 different material robot parts that varied in hard and softness.</p>
        </div><br>
